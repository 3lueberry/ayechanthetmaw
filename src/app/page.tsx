    ...
    <>
      <div
        className="relative flex place-items-center 
          ...
          after:dark:opacity-40 before:lg:h-[360px] pt-48 pb-10 lg:pt-80">
        <Image className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert" src="/img/next.svg" alt="Next.js Logo" width={180} height={37} priority />
      </div>

      <div className="grid text-center lg:grid-cols-4 lg:text-left pb-24">
        <a
