...
const Footer = () => {
  return (
    <div className="relative mx-auto lg:max-w-screen-xl flex flex-col items-center justify-between lg:flex-row">
      <div className="hidden lg:block flex justify-center items-end w-auto p-1.5">
        <Breadcrumbs />
      </div>
      <div className="flex items-center justify-center w-full lg:h-auto lg:w-auto lg:bg-none lg:p-4">
        <a
          ...
          <Image className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] w-auto h-5 w-[auto] dark:invert" src="/img/next.svg" alt="Next.js Logo" height={20} width={100} priority />
        </a>
      </div>
    </div>
  );
